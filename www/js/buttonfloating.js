    ...
    $.kc.fab = function(el, links, options){
        ...
        base.init = function(){
            ...
            if (base.links.length > 0){
				...
				bg_img_style   = (main_btn.background)? "background-image:\""+main_btn.background+"\";" : "' ";
				width_style = (main_btn.width)? "width:"+main_btn.width+";" : "";
				height_style = (main_btn.height)? "height:"+main_btn.height+";" : "";
				
                main_btn_dom = "<button data-link-href='"+((main_btn.url)?main_btn.url:"")+"' data-link-target='"+((main_btn.target)?main_btn.target:"")+"' class='kc_fab_main_btn' onClick='"+((main_btn.onClick)?main_btn.onClick:"")+"' style='"+bg_color_style+" "+bg_img_style+" "+width_style+" "+height_style+" '><span style='"+color_style+"'>"+main_btn.icon+"</span></button>";
                ...
                for (var i = 0; i < base.links.length; i++) {
					...
					bg_img_style   = (base.links[i].background)? "background-image:\""+base.links[i].background+"\";" : "";		
					width_style = (main_btn.width)? "width:"+main_btn.width+";" : "";
					height_style = (main_btn.height)? "height:"+main_btn.height+";" : "";
                    ...
                    sub_fab_btns_dom += "<div><button "+id_elem+" data-link-title='"+base.links[i].title+"' data-link-href='"+(base.links[i].url?base.links[i].url:"")+"' data-link-target='"+((base.links[i].target)?base.links[i].target:"")+"' class='sub_fab_btn' onClick='"+((main_btn.onClick)?main_btn.onClick:"")+"' style='"+bg_color_style+" "+bg_img_style+" "+width_style+" "+height_style+"'><span style='"+color_style+"'>"+base.links[i].icon+"</span></button></div>";
